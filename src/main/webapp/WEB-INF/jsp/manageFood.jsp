    ...
    <div class="table-responsive">
     ...
     <div class="clearfix"> </div>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
         <c:forEach var="food" items="${foods}" varStatus="theCount">
          <tr>
            ...
            data-id="${food.id}:${food.name}"   class="editFood" id="myBtn${food.id}">Edit</td>
          </tr>
         </c:forEach>
        </tbody>
      </table>
...
<script type="text/javascript">
    $(document).ready(function () {
             ...
             $(document).on("click", "#addFood", function (e) {
            ...
            $('.editFood').click(function () {
                        ...
                        $('#myModalEdit').find('#foodId').val(id.split(":")[0]);
                        $('#myModalEdit').find('#nameEditInput').val(id.split(":")[1]);

                        $('#myModalEdit').modal();
                    });

         $(document).on("click", "#editFoodId", function (e) {
      ...
      <div class="modal-body">
        <form class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control1" id="nameInput" placeholder="Enter Food name">
                    </div>
                    <div class="col-sm-2">
...
<div id="myModalEdit" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
      <button type="button" class="btn btn-primary" id="editFoodId">Edit</button>
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      </div>
    </div>
